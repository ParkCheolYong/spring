	...
	<div class="row">
		<div class="col-md-12">
			<div class="page-header">
				<h1>${bean.num }번 글<small>(${bean.nalja })</small></h1>
			</div>		
		</div>
	</div>
	<div class="row">
			...
			<form class="form-horizontal" action="update.bit" method="post">
			  ...
			  <div class="form-group">
			    <div class="col-sm-offset-2 col-sm-5">
			      <button type="submit" class="btn btn-primary btn-block">수 정</a>
			    </div>
			    <div class="col-sm-5">
			      <button type="reset" class="btn btn-default btn-block">삭 제</button>
			    </div>
			  </div>
			</form>	
